...
function App() {
  ...
  const [intialValue, setInitialValue] = useState(1)
  ...
  const func = (e) => {
    ...
    let fromCurrency = document.getElementsByClassName("fromInput")[0].value;
    ...
    axios.get(url).then((res) => {
      ...
      toCurrency.value="" +(parseFloat(rate) * parseFloat(fromCurrency)).toFixed(2);
      });
